...
## Authentication
Some of the methods defined in this documentation require identification of a particular Zego customer.
...
<aside class="notice">
You should respond to the webhook by making a call to the <code>/v1/user/match</code> endpoint, with the <code>success</code> variable set to <code>true</code> if the customer number could be matched to a user in your system, and <code>success</code> set to <code>false</code> if no match could be made.
</aside>
